...
**This key is public.** It's committed to this repository and known to anyone who clones it. Don't use it for anything that needs real security — no browser or media player will trust it either, so SignedPolicy viewer links (see the Access settings page) won't really work correctly until you replace it.
